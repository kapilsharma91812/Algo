...
public class TravelingSalesmanHeldKarp {
    ...
    public static void main(String[] args) {
        TravelingSalesmanHeldKarp obj = new TravelingSalesmanHeldKarp();
        List<Set<Integer>> combination = obj.generateCombination(4);
        for (Set<Integer> mset: combination) {
            for(Integer aInteger: mset) {
